...
export default class VideoPaymentSuccessPage extends Component {
    constructor(props) {
        super(props)
        this.state = {
            content_2: '',
            ...
            <View style={{ flex: 1, height: '100%', width: '100%', backgroundColor: '#FFFFFF' }}>
                ...
                <View style={{flex:1, alignSelf: 'center', alignItems: 'center', justifyContent: 'center'}}>
                    <View style={{height:mobileH*38/100, width:mobileW*84/100, elevation:4, backgroundColor: Colors.theme_color, alignItems: 'center',borderRadius:18, shadowColor:'#000000',shadowOffset: {width: 2,height: 2,},shadowOpacity: 0.30}}>
                        <Image resizeMode="contain" style={{ width: 120, height: 120,marginTop:20 }} source={localimag.successwhite}></Image>
                        ...
                        <View style={{width:mobileW*80/100, alignSelf: 'center'}}>
                            <Text style={{fontFamily: Font.medium, fontSize:mobileW*3.8/100, textAlign:'center', color:Colors.purewhite, letterSpacing:1, fontFamily: 'Roboto-Bold'}}>Your payment has been successfully sent</Text>
                        </View>
                        <TouchableOpacity activeOpacity={1} onPress={()=>{this.props.navigation.navigate('Classes')}}
